...
\begin{figure}
\includegraphics{A2-1} \appendcaption{A2}{Foutier spectrum}\label{fig:A2}
\end{figure}

\begin{figure}
\includegraphics{A3-1} \appendcaption{A3}{Trends for each index at each level. Shading indicates the 95\% confidence interval.}\label{fig:A3}
\end{figure}
