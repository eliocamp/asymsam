...
affect all Eastern Australia (panel b.5).
...
relationship with the Symmetric SAM and the Western, by the Asymmetric
...
regression coefficients are statistically significant at the 95\% level.
The Spring signal is broadly consistent with \citet{hendon2007}, but
...
coefficients have the consistent sign).
