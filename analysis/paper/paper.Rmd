...
indices_2d_yearly %>% 
  ...
  geom_point(data = data.frame(lon = ConvertLongitude(c(50, 166, -76)),
             ...
             shape = 21, color = "black", fill = "#de3e80") +
  scale_x_longitude() +
  scale_y_latitude(limits = c(NA, -20), labels = NULL) +
